...
public class TaxiFromUpUpAndShoot extends SequentialCommandGroup {
    ...
    //Taxi from up up tarmac, shoot pre-loaded cargo, park near up tarmac.
    ...
    public TaxiFromUpUpAndShoot(Shooter shooter, SwerveDrive swerveDrive, Conveyor conveyor, Intake intake, Hood hood, Flap flap) {
        ...
        var taxiFromUpUpTarmac = PathPlanner.loadPath("p0 - Taxi from up up tarmac(2.1)", Constants.Autonomous.MAX_VEL, Constants.Autonomous.MAX_ACCEL);
        new PPSwerveControllerCommand(taxiFromUpUpTarmac,
                swerveDrive::getPose,
        ...
        new PPSwerveControllerCommand(goToUpTarmac,
                swerveDrive::getPose,
                swerveDrive.getKinematics(),
                new PIDController(Constants.Autonomous.KP_X_CONTROLLER, 0, 0),
                new PIDController(Constants.Autonomous.KP_Y_CONTROLLER, 0, 0),
