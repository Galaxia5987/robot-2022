...
public class DriveAndShoot extends HolonomicDrive {
    ...
    private final DoubleSupplier correctionSupplier;
    ...
    public DriveAndShoot(SwerveDrive swerveDrive, DoubleSupplier forwardSupplier, DoubleSupplier strafeSupplier, DoubleSupplier rotationSupplier, DoubleSupplier yawSupplier, DoubleSupplier correctionSupplier, BooleanSupplier condition, DoubleSupplier distanceSupplier) {
        super(swerveDrive, forwardSupplier, strafeSupplier, rotationSupplier);
        this.yawSupplier = yawSupplier;
        this.correctionSupplier = correctionSupplier;
            ...
            if (condition.getAsBoolean()) {
                if (yawSupplier.getAsDouble() == -100) {
                    ...
                    if (sampleYawTimer.hasElapsed(Constants.SwerveDrive.SAMPLE_YAW_PERIOD)) {
                        target = Robot.getAngle().minus(Rotation2d.fromDegrees(yawSupplier.getAsDouble() + correctionSupplier.getAsDouble()));
                        System.out.println("Correction: " + correctionSupplier.getAsDouble());
                        sampleYawTimer.reset();
                    }
